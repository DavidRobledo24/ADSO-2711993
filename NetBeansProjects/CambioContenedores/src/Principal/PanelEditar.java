...
public class PanelEditar extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        panelContenidoLayout.setVerticalGroup(
            ...
            .addGroup(panelContenidoLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(textNombres, javax.swing.GroupLayout.DEFAULT_SIZE, 30, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabel3, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(textApellidos, javax.swing.GroupLayout.DEFAULT_SIZE, 30, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(textCorreo, javax.swing.GroupLayout.DEFAULT_SIZE, 28, Short.MAX_VALUE)
                .addGap(29, 29, 29)
    ...
    private void BtnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnBuscarActionPerformed
        ...
        try (PreparedStatement pstmt = bd.conexion.prepareStatement(consulta)) {
            pstmt.setString(1, documentoABuscar);
    ...
    private void BtnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditarActionPerformed
        String cedulaAEditar = textDocumento.getText();
        String nombreNuevo = textNombres.getText();
        String apellidosNuevos = textApellidos.getText();
        String telefonoNuevo = textTelefono.getText();
        String correoNuevo = textCorreo.getText();
        bd.editarUsuario(cedulaAEditar,nombreNuevo,apellidosNuevos,telefonoNuevo,correoNuevo);
